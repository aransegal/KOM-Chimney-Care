        ...
        <div className="bg-white border border-green-200 rounded-2xl p-8">
          ...
          <ul className="space-y-4 mb-8">
            <li className="flex items-start gap-3 text-slate-600">
              ...
              <div>
                <div className="font-semibold text-slate-800 text-xl">Receive Your Invoice</div>
            ...
            <li className="flex items-start gap-3 text-slate-600">
              ...
              <div>
                <div className="font-semibold text-slate-800 text-xl">Select &quot;Affirm&quot; at Checkout</div>
            ...
            <li className="flex items-start gap-3 text-slate-600">
              ...
              <div>
                <div className="font-semibold text-slate-800 text-xl">Pick Your Plan</div>
