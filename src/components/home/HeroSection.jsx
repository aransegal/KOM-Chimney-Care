    ...
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 lg:py-32">
        <div className="max-w-3xl">
          ...
          <p className="mb-10 text-xl leading-relaxed max-w-2xl text-[hsl(var(--card))]">Fast, professional chimney cleaning, inspection, and repair. Licensed technicians, transparent pricing, and same-day service available.
          </p>
