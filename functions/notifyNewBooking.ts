...
Deno.serve(async (req) => {
    try {
        ...
        await base44.asServiceRole.integrations.Core.SendEmail({
            ...
            body: `
<p>A new booking request has been submitted on KOM Water Heaters.</p>
<br>
...
<br>
<p>Log in to the <a href="https://699c9ea61bf0c459e3994bae.base44.app/AdminDashboard">admin dashboard</a> to manage this booking.</p>
<br>
<p style="color: #999; font-size: 12px;">If you'd like to unsubscribe and stop receiving these emails <a href="mailto:aran.segal@gmail.com?subject=Unsubscribe">click here</a>.</p>
            `.trim()
        });
